<div class="container-fluid">
	<div class="row">
		<div id="box1" class="col-sm-9">
			...
			<div class="card mb-2">
				<div class="card-header"> Logs Folder </div>
				<div class="card-body">
					<?php
					if (isset($error)) {
						echo "<div>$error</div>";
					} else { ?>
						<select id="umtslogs-folder-path" class="custom-select">
		...
		<div class="col-sm-3">
			<div class="card">
				...
				<div class="card-body">
					<button id="umtslogs-run-view-logs" type="button" class="btn btn-lg btn-block">View Logs</button>
				</div>
			</div>
		</div>
	</div>
